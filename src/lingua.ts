...
const testi = {
  it: {
    ...
    passoCondividi: 'Tocca Condividi, in basso nella barra di Safari',
    passoAggiungi: 'Scorri e scegli «Aggiungi alla schermata Home»',
    passoMenu: 'Apri il menu del browser, in alto a destra',
    passoInstalla: 'Scegli «Installa app» o «Aggiungi a schermata Home»',
  ...
  en: {
    ...
    passoCondividi: 'Tap Share, at the bottom of the Safari bar',
    passoAggiungi: 'Scroll and choose "Add to Home Screen"',
    passoMenu: 'Open the browser menu, top right',
    passoInstalla: 'Choose "Install app" or "Add to Home screen"',
